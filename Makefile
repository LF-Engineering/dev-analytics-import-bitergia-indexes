GO_BIN_FILES=import-bitergia-indexes.go
GO_BIN_CMDS=import-bitergia-indexes
...
BINARIES=import-bitergia-indexes
STRIP=strip

all: check ${BINARIES}

import-bitergia-indexes: import-bitergia-indexes.go
	 ${GO_ENV} ${GO_BUILD} -o import-bitergia-indexes import-bitergia-indexes.go
